...
void IkinciHaritaIslemleri(){
        ...
        printf("\nGirdiginiz degerlere gore haritayi gormek icin Harita ekranina tiklayin...\n");
            ...
            }else{resimc=load_bitmap("ydentye.bmp",0);
            draw_sprite(screen,resimc,277,229);}
